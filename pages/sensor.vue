    ...
    <div class="container mx-auto">
      ...
      <form>
        <div class="flex flex-col md:flex-row items-center py-2">
          <div class="flex-1">From camera:</div>
          <div class="flex-2">
            <select
              v-model="input.from"
        ...
        <div class="flex flex-col md:flex-row items-center py-2">
          <div class="flex-1">To camera:</div>
          <div class="flex-2">
            <select
              v-model="input.to"
              class="w-full rounded-lg border-2 border-gray-200 focus:border-indigo-600 ring-0 focus:ring-1 ring-indigo-600 px-4 py-2"
        ...
        <div class="flex flex-col md:flex-row items-center py-2 w-full">
          <div class="flex-1">Lens focal length:</div>
          ...
          <div class="flex-1 py-2 md:py-0">Desired aspect ratio:</div>
          <div class="flex-2 w-full">
            ...
            >
              ...
              <option value="0.7407407407407407">2.40:1 (cropped)</option>
